...
float dividirOperandos(float x,float y) // Función que calcula el cociente de dos números flotantes.
{
...
float multiplicarOperandos(float x,float y) // Función que calcula la multiplicación de dos números flotantes.
{
...
int factorial(int x) // Función que calcula el factorial de un número entero.
{
